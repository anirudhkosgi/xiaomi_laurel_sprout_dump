...
cat system/system/system_ext/priv-app/StatixSettings/StatixSettings.apk.* 2>/dev/null >> system/system/system_ext/priv-app/StatixSettings/StatixSettings.apk
rm -f system/system/system_ext/priv-app/StatixSettings/StatixSettings.apk.* 2>/dev/null
